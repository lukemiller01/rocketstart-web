...
export const createUser = async (req, res) => {
  ...
  try {
    ...
    var link = await firebaseAdmin.firebase.generateEmailVerificationLink(
      email
    );
    ...
    const html = fs.readFileSync(
      path.resolve("../server/public/html/verification.html"),
      "utf-8"
    );
      ...
      Attachments: [
        {
          ...
          Content: fs
            .readFileSync("../server/public/images/rocketstartLogo256.png")
            .toString("base64"),
...
export const resendVerification = async (req, res) => {
  ...
  try {
    ...
    // Get the correct HTML file & replace content.
    const html = fs.readFileSync(
      path.resolve("../server/public/html/new-verification.html"),
      "utf-8"
    );
    var template = Handlebars.compile(html);
    var replacements = {
...
export const resetPassword = async (req, res) => {
  ...
  try {
    ...
    // Get the correct HTML file & replace content.
    const html = fs.readFileSync(
      path.resolve("../server/public/html/reset-password.html"),
      "utf-8"
    );
    var template = Handlebars.compile(html);
    var replacements = {
