...
const Find = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>
          Find the recruiter for any job application in one click · Rocketstart
        </title>
      </Helmet>
      <Navbar2 />
      <div className="find">
        <div className="rows">
          ...
          <p
            id="poc__title"
            className="find__paragraph-header"
          ...
          >
            <div>
              <div className="find__biography-container">
                ...
                <img
                  src={LinkedIn}
                  alt="LinkedIn icon"
                  className="footer__icon-find"
                />
              </div>
              <p className="find__paragraph-header">Sr. Recruiter @ Google</p>
              <div className="match__container">
                <span className=" material-symbols-outlined verified__icon">
                  verified_user
                </span>
            ...
            <div className="find__right-buttons">
              <button className="navbar__button save__button">Save</button>
            </div>
          </div>
        </div>
      </div>
