...
const Verification = ({ userEmail }) => {
  ...
  function handleEmailEdit() {
    if (buttonText === "Edit Email or Resend") {
      // USER STARTS ACTION. Change from "Edit Email or Resend" to "Cancel"
      setButtonText("Cancel");
      ...
      // USER CANCELS ACTION. Change from "Cancel" to "Edit Email or Resend"
      setInputVis("");
  ...
  return (
    <div className="verification__bg">
      <div className="verification__modal">
        ...
        <p className="verification__modal-text">Email sent to:</p>

        <p>
          <font className="verification__modal-email"> {email}</font>
        </p>
