...
const testimonalData = [
  {
    ...
    review:
      '"Great extension that makes connection requests a breeze. Great work!"',
  },
  {
    name: "Steve Jobs",
    title: "Founder @ Apple",
    ...
    review:
      '"Networking is the key to landing a job. Rocketstart makes it easy to network. I love its simplicity, and see a difference in the responses I\'m receiving!"',
  },
  {
