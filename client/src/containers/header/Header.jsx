    ...
    <div className="header">
      <div className="header__content-container">
        <div className='left__content'>
          <AnimationOnScroll animateOnce={true} animateIn='fadeInUp' duration={1}>
          ...
          <div className='cta__benefit-container'>
              <AnimationOnScroll animateOnce={true} duration={1} animateIn='fadeInLeft' delay={100} className='cta__benefits'>
              ...
              <AnimationOnScroll animateOnce={true} duration={1} animateIn='fadeInLeft' delay={200} className='cta__benefits'>
                  <span className="material-icons header__check">check_circle</span>
                  <p className='cta__text'>
                    Maximize reply rates on LinkedIn with text analysis
                  </p>
              </AnimationOnScroll>
              <AnimationOnScroll animateOnce={true} duration={1} animateIn='fadeInLeft' delay={300} className='cta__benefits'>
                  <span className="material-icons header__check">check_circle</span>
                  <p className='cta__text'>Receive contact suggestions until you make a connection</p>
              </AnimationOnScroll>
          </div>
          <AnimationOnScroll animateOnce={true} offset={1000} duration={1} animateIn='fadeInDown' className='button__container'>
            <Link to='/login'>
        ...
        <AnimationOnScroll animateOnce={true} offset={1000} animateIn='fadeInRight' duration={1} className='right__content' >
